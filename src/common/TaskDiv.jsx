...
const TaskDiv = ({ img, alt, onClick, classes }) => {
    return (
        <div className='flex items-center justify-start rounded-xs z-10 h-[1.87rem] shadow-[inset_0px_0px_0px_1px_#5590FC] w-36 cursor-pointer' style={{
